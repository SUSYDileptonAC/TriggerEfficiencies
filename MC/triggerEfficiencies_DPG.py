...
#~ 
		#~ 
				...
				if source == "HT" or source == "AlphaT":
					hCanvas.Print("TriggereffDPG_%s_%s_%s_%s_%s.pdf"%(source,cut.name,run.plotName,variable.plotName,variable.additionalPlotName))
				else:
					hCanvas.Print("TriggereffDPG_%s_%s_%s_%s.pdf"%(cut.name,run.plotName,variable.plotName,variable.additionalPlotName))
				#~ hCanvas.Clear()
...
#~ 
				...
				if source == "HT" or source == "AlphaT":
					hCanvas.Print("TriggereffDPG_SFvsOF_%s_%s_%s_%s_%s.pdf"%(source,cut.name,run.plotName,variable.plotName,variable.additionalPlotName))
				else:
					hCanvas.Print("TriggereffDPG_SFvsOF_%s_%s_%s_%s.pdf"%(cut.name,run.plotName,variable.plotName,variable.additionalPlotName))	
				...
				if source == "HT" or source == "AlphaT":
					hCanvas.Print("TriggereffDPG_SFvsOF_Syst_%s_%s_%s_%s_%s.pdf"%(source,cut.name,run.plotName,variable.plotName,variable.additionalPlotName))
				else:
					hCanvas.Print("TriggereffDPG_SFvsOF_Syst_%s_%s_%s_%s.pdf"%(cut.name,run.plotName,variable.plotName,variable.additionalPlotName))	
